  ...
  const searchSystemPrompt = [
    {
      ...
      text: [
        ...
        "PLAYER CONTEXT: Contract status (classify as exactly one of: RENTAL = expiring this season; CONTROLLABLE = multiple years of team control remaining; EXTENSION CANDIDATE = expiring but extension talks are active or likely), age, performance, primary position, any confirmed secondary positions — from search only. The contract classification is required — do not skip it.",
