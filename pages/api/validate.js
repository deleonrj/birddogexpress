  ...
  const analysisSystemPrompt = [
    {
      ...
      text: [
        ...
        "",
        "POTENTIAL SUITORS:",
        "Based on the player's position, contract, and performance from the research findings, identify 2-3 other MLB teams that could realistically pursue this player beyond the rumored destination.",
        "For each suitor evaluate:",
        "1. ROSTER FIT — does the team have a genuine need at this position? Flag if they already have an established player there.",
        "2. PAYROLL SPACE — can they absorb the contract based on known payroll posture?",
        "3. COMPETITIVE WINDOW — are they likely buyers based on standings or deadline context?",
        "4. GM TENDENCY — does this type of move fit their known approach? Note if unknown.",
        "Do NOT suggest a team that has the same position filled by a star or franchise player unless there is a known plan to move that player.",
        "Also identify ONE darkhorse team — a non-obvious fit with a logical case. Label it clearly.",
        "If research findings don't provide enough context to identify suitors, return an empty array and explain why in darkhorse_note.",
        "",
