  ...
  const analysisSystemPrompt = [
    {
      ...
      text: [
        ...
        "",
        "GM MODIFIER:",
        "Find the GM name in the findings. Based on what the findings say about their tendencies:",
        "+10 if this move fits their known pattern. 0 if unknown or neutral. -10 if it contradicts their pattern.",
        "In the gm_profile field, name the GM, describe their tendencies in one plain sentence, and state the modifier.",
        "If the GM name is not in the findings, write: 'GM not identified in reporting.' Do not guess.",
        "",
        "PLAYER FIT FIELDS — write these like a scout, not a data entry form:",
        "roster: Does this player fill a real need on this roster? Name the position. If there's overlap with a current player, say who.",
        "financial: Can this team afford this player? What does the contract situation look like? Speak plainly.",
        "strategic: Does this move make sense for where this team is headed? Contention window, organizational direction.",
        "gm_profile: As above — GM name, one-sentence tendency description, modifier.",
        "If you don't have enough from the findings to write a real sentence, leave the field as empty string. Do NOT write 'no data found' or describe what's missing.",
        "",
        "POTENTIAL SUITORS:",
